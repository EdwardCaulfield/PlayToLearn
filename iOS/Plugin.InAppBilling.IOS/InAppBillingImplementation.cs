...
using MusicTrainer2.iOS.Plugin.InAppBilling;
using StoreKit;
using System;
...
namespace MusicTrainer2.iOS.Plugin.InAppBilling
{
	/// <summary>
	...
	public class InAppBillingImplementation : BaseInAppBilling
	{
		...
		public async override Task<IEnumerable<InAppBillingPurchase>> GetPurchasesAsync(ItemType itemType, IInAppBillingVerifyPurchase verifyPurchase = null)
		{
            ...
            //foreach (SKPaymentTransaction mTransaction in purchases)
            //{
            //    Debug.WriteLine(string.Format("SK - The item {0} was purchased on {1}", mTransaction.Payment.ProductIdentifier, mTransaction.TransactionDate));
            //}

            //foreach (InAppBillingPurchase mTransaction in converted)
            //{
            //    Debug.WriteLine(string.Format("IAB - The item {0} was purchased on {1}", mTransaction.ProductId, mTransaction.TransactionDateUtc));
            //}
	...
	static class SKTransactionExtensions
	{
		...
		public static InAppBillingPurchase ToIABPurchase(this SKPaymentTransaction transaction)
		{
            ...
            InAppBillingPurchase bugger = new InAppBillingPurchase
   			{
            ...
            //Debug.WriteLine(string.Format("CVT - Original Date for {0} is {1}, new date is {2}", bugger.ProductId, p.TransactionDate, bugger.TransactionDateUtc));
